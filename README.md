...
###**Current Version: [1.8.3](https://github.com/taplytics/Taplytics-Android-SDK/releases/tag/1.8.3)** |   	 [FAQ](https://github.com/taplytics/Taplytics-Android-SDK/blob/master/FAQ/FAQ.md)
