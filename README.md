...
###**Current Version: [1.9.5](https://github.com/taplytics/Taplytics-Android-SDK/releases/tag/1.9.5)** |   	 [FAQ](https://github.com/taplytics/Taplytics-Android-SDK/blob/master/FAQ/FAQ.md)
