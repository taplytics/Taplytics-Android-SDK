...
/**
 * Detects various gestures and events using the supplied {@link android.view.MotionEvent}s. The
 * {@link android.view.GestureDetector.OnGestureListener} callback will notify users when a particular motion event has occurred. This class
 * should only be used with {@link android.view.MotionEvent}s reported via touch (don't use for trackball events).
 *
 * <p>
 * This compatibility implementation of the framework's GestureDetector guarantees the newer focal point scrolling behavior from Jellybean
 * MR1 on all platform versions.
 * </p>
 *
 * To use this class:
 * <ul>
 * <li>Create an instance of the {@code GestureDetectorCompat} for your {@link android.view.View}
 * <li>In the {@link android.view.View#onTouchEvent(android.view.MotionEvent)} method ensure you call
 * {@link #onTouchEvent(android.view.MotionEvent)}. The methods defined in your callback will be executed when the events occur.
 * </ul>
 * 
 * 
 * NOTE: RIPPED FROM APPCOMPAT.
 */
public class GestureDetectorCompat {
	...
	static class GestureDetectorCompatImplBase implements GestureDetectorCompatImpl {
		...
		/**
		 * True when the user is still touching for the second tap (down, move, and up events). Can only be true if there is a double tap
		 * listener attached.
		 */
		...
		/**
		 * Creates a GestureDetector with the supplied listener. You may only use this constructor from a UI thread (this is the usual
		 * situation).
		 * 
		...
		/**
		 * Set whether longpress is enabled, if this is enabled when a user presses and holds down you get a longpress event and nothing
		 * further. If it's disabled the user can press and hold down and then later moved their finger and you will get scroll events. By
		 * default longpress is enabled.
		 *
		 ...
		 * {@link android.view.GestureDetector.OnGestureListener} supplied.
		 *
		 * @param ev
		 *            The current motion event.
		 * @return true if the {@link android.view.GestureDetector.OnGestureListener} consumed the event, else false.
		 */
